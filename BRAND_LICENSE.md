...
- claim sponsorship, endorsement, or affiliation without permission;
- resell or redistribute the brand assets as a standalone asset pack;
- use the brand assets in an unlawful, deceptive, defamatory, or harmful manner;
- remove ownership notices from files that contain them.

## Your own branding

The `Mascot` component accepts a `spriteSrc` property so that you can replace the demonstration mascot with artwork you own or are licensed to use. Using your own identity is the recommended approach for production applications.

## No warranty

The brand assets are provided “as is”, without warranty of any kind. All rights not expressly granted by this license are reserved.

For commercial brand licensing, open a discussion in the official repository.
